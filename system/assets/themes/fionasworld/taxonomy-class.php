...
add_action('msdlab_title_area',array('MSDLab_Animal_Support','msdlab_do_class_archive_banner'));
...
add_filter('genesis_post_title_output',array('MSDLab_Animal_Support','msdlab_do_class_archive_block'),10,3);
